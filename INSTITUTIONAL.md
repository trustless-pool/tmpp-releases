...
Place the TMPP node on the same network switch as your ASICs. Configure firewall to allow LAN access on port 3333 (Stratum) and outbound on port 9940 (gossip). No inbound internet access required.

### Miner Configuration

```
Pool URL:   stratum+tcp://192.168.1.100:3333
Worker:     bc1q_YOUR_PAYOUT_ADDRESS.facility_01
```
