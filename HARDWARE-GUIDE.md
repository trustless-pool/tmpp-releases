...
|---|---|---|---|
| 3333 | TCP | Inbound (LAN only) | Stratum V2 (miners connect here) |
...
**Do NOT expose ports 3333 or 8080 to the internet** unless you intentionally want external miners to connect. For a facility running its own ASICs, these should be LAN-only.
