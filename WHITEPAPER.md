...
| **Kaspa** | kHeavyHash (blake2b + cSHAKE256 + matrix + keccak) | gRPC via kaspactl | 1 sec | Proven (devnet, 166 blocks) |
...
```
Miners → HAProxy (:3333 TCP) → TMPP Node 1 ←gossip→ TMPP Node 2
